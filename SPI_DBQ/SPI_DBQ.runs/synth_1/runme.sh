...
HD_PWD='/home/bowang1308/Documents/SPI_DBQ/SPI_DBQ.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_Master_With_Multi_CS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_Master_With_Multi_CS.tcl
