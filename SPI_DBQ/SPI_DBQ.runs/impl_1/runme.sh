...
HD_PWD='/home/bowang1308/Documents/SPI_DBQ/SPI_DBQ.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_Master_With_Multi_CS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPI_Master_With_Multi_CS.tcl -notrace
