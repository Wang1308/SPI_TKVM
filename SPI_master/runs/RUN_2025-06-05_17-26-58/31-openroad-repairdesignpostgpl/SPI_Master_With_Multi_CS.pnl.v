module SPI_Master_With_Multi_CS (i_Clk,
 ...
 sky130_fd_sc_hd__nor3_1 _130_ (.A(net36),
    ...
    .VPWR(VPWR),
    .Y(_058_));
 sky130_fd_sc_hd__and2b_1 _131_ (.A_N(\SPI_Master_Inst.r_SPI_Clk_Count[1] ),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_002_));
 sky130_fd_sc_hd__and2_1 _132_ (.A(\SPI_Master_Inst.r_SPI_Clk_Count[1] ),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _152_ (.A1(net26),
    ...
    .VPWR(VPWR),
    .Y(_073_));
 sky130_fd_sc_hd__a311oi_1 _153_ (.A1(net25),
    .A2(net26),
    .A3(net24),
    .B1(_065_),
    .C1(_073_),
 ...
 sky130_fd_sc_hd__o21ai_1 _154_ (.A1(net36),
    ...
    .VPWR(VPWR),
    .Y(_074_));
 sky130_fd_sc_hd__o21a_1 _155_ (.A1(\SPI_Master_Inst.r_SPI_Clk_Edges[0] ),
    .A2(_058_),
    .B1(_074_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _159_ (.A(\SPI_Master_Inst.r_SPI_Clk_Edges[2] ),
    ...
    .VPWR(VPWR),
    .Y(_077_));
 sky130_fd_sc_hd__a311oi_1 _160_ (.A1(\SPI_Master_Inst.r_SPI_Clk_Edges[2] ),
    .A2(\SPI_Master_Inst.r_SPI_Clk_Count[0] ),
    .A3(_055_),
    .B1(_077_),
    .C1(net36),
 ...
 sky130_fd_sc_hd__a211oi_1 _163_ (.A1(_078_),
    ...
    .VPWR(VPWR),
    .Y(_011_));
 sky130_fd_sc_hd__a21o_1 _164_ (.A1(\SPI_Master_Inst.r_SPI_Clk_Edges[4] ),
    .A2(_078_),
    .B1(net37),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21ba_1 _191_ (.A1(\SPI_Master_Inst.r_RX_Bit_Count[2] ),
    ...
    .VPWR(VPWR),
    .X(_023_));
 sky130_fd_sc_hd__mux2_1 _192_ (.A0(net16),
    .A1(net2),
    .S(_000_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _220_ (.A(net34),
    ...
    .VPWR(VPWR),
    .Y(_040_));
 sky130_fd_sc_hd__xor2_1 _221_ (.A(\SPI_Master_Inst.r_SPI_Clk_Count[1] ),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _227_ (.A1(\SPI_Master_Inst.r_TX_DV ),
    ...
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__a22o_1 _228_ (.A1(net32),
    .A2(_108_),
    .B1(_112_),
    .B2(_113_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_042_));
 sky130_fd_sc_hd__xor2_1 _229_ (.A(\SPI_Master_Inst.r_SPI_Clk ),
    .B(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _230_ (.A(\SPI_Master_Inst.r_Trailing_Edge ),
    ...
    .VPWR(VPWR),
    .Y(_114_));
 sky130_fd_sc_hd__o21bai_1 _231_ (.A1(\SPI_Master_Inst.r_TX_DV ),
    .A2(_114_),
    .B1_N(\SPI_Master_Inst.o_TX_Ready ),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a211oi_1 _235_ (.A1(\SPI_Master_Inst.r_TX_Bit_Count[2] ),
    ...
    .VPWR(VPWR),
    .Y(_117_));
 sky130_fd_sc_hd__o21ai_1 _236_ (.A1(\SPI_Master_Inst.r_TX_Bit_Count[2] ),
    .A2(_115_),
    .B1(_117_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_046_));
 sky130_fd_sc_hd__dfrtp_1 _237_ (.CLK(i_Clk),
    .D(_004_),
    .RESET_B(net40),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\r_TX_Count[0] ));
 sky130_fd_sc_hd__dfrtp_1 _238_ (.CLK(i_Clk),
    .D(_005_),
    .RESET_B(net40),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\r_TX_Count[1] ));
 sky130_fd_sc_hd__dfxtp_1 _239_ (.CLK(i_Clk),
    .D(_006_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net24));
 sky130_fd_sc_hd__dfxtp_1 _240_ (.CLK(i_Clk),
    .D(_007_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Q(net25));
 sky130_fd_sc_hd__dfrtp_1 _241_ (.CLK(i_Clk),
    .D(_008_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _242_ (.CLK(i_Clk),
    .D(_009_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _243_ (.CLK(i_Clk),
    .D(_010_),
    .RESET_B(net40),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _244_ (.CLK(i_Clk),
    .D(_011_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _245_ (.CLK(i_Clk),
    .D(_012_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfstp_1 _246_ (.CLK(i_Clk),
    .D(_013_),
    .SET_B(net42),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net27));
 sky130_fd_sc_hd__dfstp_1 _247_ (.CLK(i_Clk),
    .D(_014_),
    .SET_B(net42),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net28));
 sky130_fd_sc_hd__dfstp_1 _248_ (.CLK(i_Clk),
    .D(_015_),
    .SET_B(net42),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net29));
 sky130_fd_sc_hd__dfstp_1 _249_ (.CLK(i_Clk),
    .D(_016_),
    .SET_B(net42),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net30));
 sky130_fd_sc_hd__dfrtp_1 _250_ (.CLK(i_Clk),
    .D(_017_),
    .RESET_B(net42),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\r_SM_CS[0] ));
 sky130_fd_sc_hd__dfrtp_1 _251_ (.CLK(i_Clk),
    .D(_018_),
    .RESET_B(net42),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(\r_SM_CS[1] ));
 sky130_fd_sc_hd__dfstp_1 _252_ (.CLK(i_Clk),
    .D(_019_),
    .SET_B(net42),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _253_ (.CLK(i_Clk),
    .D(_020_),
    .RESET_B(net42),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfstp_1 _254_ (.CLK(i_Clk),
    .D(_021_),
    .SET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfstp_1 _256_ (.CLK(i_Clk),
    .D(_023_),
    .SET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _257_ (.CLK(i_Clk),
    .D(net36),
    .RESET_B(net40),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_4 _258_ (.CLK(i_Clk),
    .D(_001_),
    .RESET_B(net40),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _259_ (.CLK(i_Clk),
    .D(_024_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net16));
 sky130_fd_sc_hd__dfrtp_1 _260_ (.CLK(i_Clk),
    .D(_025_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net17));
 sky130_fd_sc_hd__dfrtp_1 _261_ (.CLK(i_Clk),
    .D(_026_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net18));
 sky130_fd_sc_hd__dfrtp_1 _262_ (.CLK(i_Clk),
    .D(_027_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net19));
 sky130_fd_sc_hd__dfrtp_1 _263_ (.CLK(i_Clk),
    .D(_028_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net20));
 sky130_fd_sc_hd__dfrtp_1 _264_ (.CLK(i_Clk),
    .D(_029_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net21));
 sky130_fd_sc_hd__dfrtp_1 _265_ (.CLK(i_Clk),
    .D(_030_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net22));
 sky130_fd_sc_hd__dfrtp_1 _266_ (.CLK(i_Clk),
    .D(_031_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net23));
 sky130_fd_sc_hd__dfrtp_1 _267_ (.CLK(i_Clk),
    .D(_000_),
    .RESET_B(net43),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net26));
 sky130_fd_sc_hd__dfrtp_1 _268_ (.CLK(i_Clk),
    .D(_032_),
    .RESET_B(net40),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _269_ (.CLK(i_Clk),
    .D(_033_),
    .RESET_B(net40),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _270_ (.CLK(i_Clk),
    .D(_034_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _271_ (.CLK(i_Clk),
    .D(_035_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _272_ (.CLK(i_Clk),
    .D(_036_),
    .RESET_B(net40),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _273_ (.CLK(i_Clk),
    .D(_037_),
    .RESET_B(net40),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _274_ (.CLK(i_Clk),
    .D(_038_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _275_ (.CLK(i_Clk),
    .D(_039_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _276_ (.CLK(i_Clk),
    ...
    .VPWR(VPWR),
    .Q(net31));
 sky130_fd_sc_hd__dfrtp_1 _277_ (.CLK(i_Clk),
    .D(_040_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _278_ (.CLK(i_Clk),
    .D(_041_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _279_ (.CLK(i_Clk),
    .D(_042_),
    .RESET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Q(net32));
 sky130_fd_sc_hd__dfrtp_1 _280_ (.CLK(i_Clk),
    .D(_043_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfstp_1 _281_ (.CLK(i_Clk),
    .D(_044_),
    .SET_B(net40),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfstp_1 _282_ (.CLK(i_Clk),
    .D(_045_),
    .SET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfstp_1 _283_ (.CLK(i_Clk),
    .D(_046_),
    .SET_B(net41),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _284_ (.CLK(i_Clk),
    .D(_002_),
    .RESET_B(net38),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__dfrtp_1 _285_ (.CLK(i_Clk),
    .D(_003_),
    .RESET_B(net39),
    .VGND(VGND),
    .VNB(VGND),
